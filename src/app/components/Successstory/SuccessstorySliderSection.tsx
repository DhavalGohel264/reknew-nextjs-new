...
import SuccessStoryOne from './SuccessStoryOne';
import SuccessStoryTwo from './SuccessStoryTwo';
import SuccessStoryThree from './SuccessStoryThree';
                ...
                <div className="flex justify-center space-x-4 mt-4 md:mt-0">
                    <button
                        ...
                        <div className="flex items-center justify-center w-full h-full">
                            {/* <img src={Arrow} alt="Previous" className="rotate-[210deg] w-[67.5%] left-2 top-[9px] absolute object-contain" loading="lazy" /> */}
                            {/* <Image
                                            src="/assets/Arrow-logo.png"
                                            alt="Previous"
                                            width={0}
                                            height={0}
                                            className="rotate-[210deg] w-[67.5%] left-2 top-[9px] absolute object-contain"
                                            /> */}
                            <img
                                    src="/assets/Arrow-logo.png"
                                    alt="Previous"
                    ...
                    <button
                        ...
                        <div className="flex items-center justify-center w-full h-full">
                            {/* <img src={Arrow} alt="Next" className="rotate-[28deg] w-[67.5%] right-2 top-[13px] absolute object-contain" loading="lazy" /> */}
                            {/* <Image
                                            src="/assets/Arrow-logo.png"
                                            alt="Previous"
                                            width={0}
                                            height={0}
                                            className="rotate-[28deg] w-[67.5%] right-2 top-[13px] absolute object-contain"
                                            /> */}
                                 <img
                                    src="/assets/Arrow-logo.png"
                                    alt="Previous"
